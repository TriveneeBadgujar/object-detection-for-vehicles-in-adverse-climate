...
# ---------------- WEATHER (KEPT BUT NOT USED FOR MODEL) ----------------
...
# ✅ NEW: MODEL SELECTOR
model_choice = st.sidebar.radio("Select Model", ["COCO (General)", "BDD100K (Custom)"])

# ✅ SET MODEL
if model_choice == "COCO (General)":
...
if mode == "Image":
    ...
    if file:
        ...
        # optional display only (not for model)
